...
-- Show Hotkeys Popup
  awful.key({ modkey }, "s", hotkeys_popup.show_help, { description = "View Hotkeys", group = "awesome" }),
  ...
  end, { description = "Make Client bigger horizontally", group = "layout" }),

  -- Make Client Smaller horizontally
  awful.key({ modkey }, "h", function()
    awful.tag.incmwfact(-0.05)
  end, { description = "Make Client smaller horizontally", group = "layout" }),
...
for i = 1, 9 do
  keys.globalkeys = gears.table.join(
    ...
    end, { description = "Move tag #" .. i .. " on next screen", group = "tag" }),
