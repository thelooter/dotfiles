...
-- Use builtin `vim.fs` for root detection instead of the deprecated lspconfig util
...
local servers = {
	...
	gradle_ls = {
		...
		root_dir = function(fname)
			...
			local found = vim.fs.find({ "settings.gradle", "settings.gradle.kts", "build.gradle" }, { path = path, upward = true })
